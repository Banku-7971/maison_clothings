...
// ═══════════════════════════════════════════════════════════════
// MAISON — PRODUCT DETAIL PAGE
// ═══════════════════════════════════════════════════════════════
// The complete product experience.
// Where visitors become owners.
//
// Features:
    ...
    return (
      <div className="min-h-screen bg-noir flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-cormorant text-4xl text-ivory mb-4">
            Piece not found
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {product.isNew && (
                  <span 
                    className="inline-block px-3 py-1 bg-gold text-noir text-tiny tracking-mega uppercase"
                ...
                {product.isBestseller && (
                  <span 
                    className="inline-block px-3 py-1 border border-ivory text-ivory text-tiny tracking-mega uppercase"
                    style={{ fontSize: '0.6rem' }}
                  >
                    Bestseller
                  </span>
                ...
                {product.isLimited && (
                  <span 
                    className="inline-block px-3 py-1 border border-gold text-gold text-tiny tracking-mega uppercase"
                    style={{ fontSize: '0.6rem' }}
                  >
                    Limited Edition
                  </span>
                ...
                {product.isSustainable && (
                  <span 
                    className="inline-block px-3 py-1 border border-forest text-forest text-tiny tracking-mega uppercase"
                    style={{ fontSize: '0.6rem' }}
                  >
                    Sustainable
                  </span>
              ...
              <div className="flex gap-3 mb-8">
                ...
                <button
                  onClick={handleShare}
                  className="w-14 h-14 flex items-center justify-center border border-graphite text-ivory hover:border-ivory transition-all duration-400"
                  aria-label="Share"
                  data-cursor="hover"
                >
                  <FiShare2 size={16} />
              ...
              <div className="grid grid-cols-3 gap-4 mb-12 py-6 border-y border-graphite/30">
                {[
                  { icon: FiTruck, label: 'Free Shipping', sub: 'Worldwide' },
                  { icon: FiRefreshCw, label: 'Easy Returns', sub: '30 days' },
                  { icon: FiShield, label: 'Handcrafted', sub: 'Paris atelier' },
                ].map((item, i) => (
              ...
              <div>
                ...
                <AccordionSection title="Shipping & Returns">
                  <div className="space-y-4 text-sm text-platinum font-cormorant leading-relaxed">
                    <div>
                      ...
                      <p>International: {product.delivery?.international}</p>
                    </div>
                ...
                <AccordionSection title="Origin & Craftsmanship">
                  <p className="text-sm text-platinum font-cormorant italic leading-relaxed">
                    ...
                    of the artisan who created it — a signature of care that 
