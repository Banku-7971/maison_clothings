...
// ═══════════════════════════════════════════════════════════════
// MAISON — CINEMATIC LOADING SCREEN
// ═══════════════════════════════════════════════════════════════
// The first impression. The overture.
// Every visitor's introduction to the world of MAISON.
//
// Features:
// - Logo letter-by-letter reveal
// - Loading percentage counter (0-100%)
// - Gold progress bar with expo easing
// - Tagline reveal
...
const LoadingScreen = () => {
  ...
  // ─────────────────────────────────────────
  // LOGO LETTERS
  // Split "MAISON" for stagger animation
  // ─────────────────────────────────────────
  ...
  return (
    ...
    >
      ...
      {/* ═══════════════════════════════════════
          CORNER MARKERS (Cinematic touch)
      ═══════════════════════════════════════ */}
      <motion.div
